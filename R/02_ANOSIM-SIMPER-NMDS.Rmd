...
And from the `indicspecies` [package vignette](https://cran.r-project.org/web/packages/indicspecies/vignettes/IndicatorSpeciesAnalysis.html):

Indeed, the indicator value index is the product of two components, called 'A' and 'B' (Dufrêne and Legendre 1997; De Cáceres and Legendre 2009):
