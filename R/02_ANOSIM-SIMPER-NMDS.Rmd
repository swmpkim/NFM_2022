...
pal <- data.frame("habitat_type" = unique(expl$habitat_type),
                  "color" = viridis::viridis(n = 5, option = "H"))
...
legend3d("bottomleft", legend = pal$habitat_type, pch = 16, col = pal$color, ncol = 2, cex = 0.8, inset = c(0.02), text.width = NA)

# add	
# whether to add the points to an existing plot.
# might be able to get some species on here???
